...
#define MSG_Z_FADE_HEIGHT                   _UxGT("Kiegyenlítási magasság")
...
#define MSG_WATCH                           _UxGT("Infó")
#define MSG_PREPARE                         _UxGT("Elôkészítés")
#define MSG_TUNE                            _UxGT("Finombeáll.")
#define MSG_PAUSE_PRINT                     _UxGT("SD-Pause")
#define MSG_RESUME_PRINT                    _UxGT("SD-folytatás")
#define MSG_STOP_PRINT                      _UxGT("SD-megszakítás.")
...
#define MSG_DELTA_HEIGHT_CALIBRATE          _UxGT("Delta magasság beállítás")
#define MSG_DELTA_DIAG_ROD                  _UxGT("Diag Rod")
#define MSG_DELTA_HEIGHT                    _UxGT("Magasság")
#define MSG_DELTA_RADIUS                    _UxGT("Sugár")
#define MSG_INFO_MENU                       _UxGT("INfo")
...
#define MSG_INFO_STATS_MENU                 _UxGT("Nayomtató stat.")
...
#define MSG_UBL_RESTORE_ERROR             _UxGT("ERR:Visszaállítási hiba")
#define MSG_UBL_Z_OFFSET_STOPPED          _UxGT("Z-eltolás kikapcsolva")
...
#define MSG_M600_TOO_COLD                   _UxGT("M600: Túl hideg")
  ...
  #define MSG_FILAMENT_CHANGE_UNLOAD_2        _UxGT("a szálcsere")
